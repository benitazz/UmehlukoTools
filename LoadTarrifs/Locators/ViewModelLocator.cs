/*
  ...
  <Application.Resources>
      <vm:ViewModelLocator xmlns:vm="clr-namespace:LoadTarrifs"
                                   x:Key="Locator" />
  </Application.Resources>
...
using Umehluko.Tools.UI.ViewModels;

namespace Umehluko.Tools.UI.Locators
{
    /// <summary>
    ...
    public class ViewModelLocator
    {
        ...
        public TarrifManagementViewModel TarrifManagementViewModel
        {
            get
            {
                return new TarrifManagementViewModel();
            }
        }
    }
}